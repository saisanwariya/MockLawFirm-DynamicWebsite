...
if(isset($_POST) && count($_POST) > 0) {
  $careers = '';
  if(!empty($_FILES['careers']['name'])) {
    $file_name = str_replace(' ', '_', $_FILES['careers']['name']);
    move_uploaded_file($_FILES['careers']['tmp_name'], 'uploads/'.$file_name);  
  }
  ...
  $sql = "INSERT INTO careers (name, qualification, file_name ) VALUES ('$name','$qualification','$file_name')";

if(mysqli_query($link, $sql)){

    $app_msg = "Your successfully applied Careers";
    ...
    <div class="container">
      <div class="row">
           ...
           <div style="min-height:250px;">
            ...
            <h3>Apply for Careers</h3> 
            
            <p>Thank you for your interest in legal employment opportunities at Pearson Spector Litt.  If you are interested in applying for an associate or summer associate position, paralegals and administrative staff we encourage you to sign up to see us on our office.  If that is not possible, please send your resume, a copy of your law school transcript and a cover letter indicating your practice area interest to recruiting@psl.com.</p>

            <h2 style="color: #f00;"><?php echo  $app_msg; ?> </h2>
          ...
          <select id="qualification" name="qualification" class="form-control" required>
                <option value="0" selected>  </option> 
                  ...
                  <option value="2">SJD</option>
                  <option value="3">LLM</option>
                  <option value="4">MD</option>
                  <option value="5">BS</option>
                  <option value="6">LHD</option>
                  <option value="7">AQF</option>
                  
          </select>
          
          <label>Upload Resume:</label>
          <input type="file" name="careers" required >
                      
          <br />
          <input type="submit" class="btn btn-success" name="submit" value="Upload Profile" style="width:130px;"  />
        </form>
        </div>
        </div>
